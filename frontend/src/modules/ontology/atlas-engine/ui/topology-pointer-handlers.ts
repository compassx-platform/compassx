...
import { DEFAULT_EXPAND, type ExpandPreference } from "@/modules/ontology/shared/appearance-preferences";
...
export function createTopologyPointerHandlers(refs: PointerHandlerRefs): TopologyPointerHandlers {
  ...
  const handlePointerMove = (e: ReactPointerEvent<HTMLCanvasElement>) => {
    ...
    const edgeHit =
      hitNodeId === null && hoveredEdgeRef
        ? hitTestEdges(buildEdgeCandidates(), point.x, point.y, 12)
        : null;
