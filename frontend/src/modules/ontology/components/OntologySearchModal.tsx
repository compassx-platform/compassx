              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span className="text-[10px] font-medium px-2 py-0.5 rounded bg-[#141724] text-[#94a3b8] border border-[#20263c]">
                      {n.kind === 'org' || n.kind === 'project' ? 'Organization' : n.kind === 'domain' ? 'Domain' : n.kind === 'subdomain' || n.kind === 'capability' ? 'Subdomain' : n.kind === 'element' ? 'Element' : n.kind}
                    </span>
